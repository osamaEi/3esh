                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="flex justify-between items-center mb-6">
                            <h2 class="text-xl font-semibold text-gray-800">Vendor Registration</h2>
                        </div>
                        ...
                        <form id="vendor-registration-form" action="{{ route('vendors.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                            ...
                            <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                                    ...
                                    <!-- Photo Upload -->
                                    <div>
                                        <label for="photo" class="block text-sm font-medium text-gray-700">Business Photo</label>
                                        <div class="mt-1 flex items-center">
                            ...
                            <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                                ...
                                <div id="employees-container">
                                    ...
                                    <div id="employee-template" class="employee-entry hidden border border-gray-200 rounded-md p-4 mb-4">
                                        <div class="flex justify-between items-center mb-4">
                                            <h4 class="text-md font-medium text-gray-700">Employee <span class="employee-number">1</span></h4>
